...
:checkMCmd
if exist "%RCT_HOME%\bin\transgui.cmd" goto chkVersion
goto error
...
set MAIN_CLASS=org.example.gui.MizTranslatorLauncher
...
if %JVER% GEQ 900 set ADD_OPENS=--add-opens=java.base/java.lang.invoke=ALL-UNNAMED --enable-native-access=ALL-UNNAMED
